    ...
    <div className="pt-40 pb-24 px-6 lg:px-12 max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
        ...
        <div>
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-12 font-light">Partner with Nepal's fastest-growing premium distillery.</p>
          <div className="space-y-6">
            <div className="liquid-glass p-6 bg-white/5 border-none flex items-start gap-4">
              <MapPin className="text-brand-gold" size={24} />
              <div>
                  <h3 className="text-xs font-black uppercase tracking-widest text-brand-gold mb-2">Corporate Office</h3>
                  <p className="text-lg font-light">Birgunj, Nepal</p>
              </div>
            </div>
            <div className="liquid-glass p-6 bg-white/5 border-none flex items-start gap-4">
              <Mail className="text-brand-gold" size={24} />
              <div>
                  <h3 className="text-xs font-black uppercase tracking-widest text-brand-gold mb-2">Email Us</h3>
                  <p className="text-lg font-light">arunodayadistallary@gmail.com</p>
              </div>
            </div>
            <div className="liquid-glass p-6 bg-white/5 border-none flex items-start gap-4">
              <Phone className="text-brand-gold" size={24} />
              <div>
                  <h3 className="text-xs font-black uppercase tracking-widest text-brand-gold mb-2">Call Us</h3>
                  <p className="text-lg font-light">+977 980-1218585</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="liquid-glass p-10">
          <h2 className="text-3xl font-serif mb-8 text-brand-gold">Send a Message</h2>
          <form className="space-y-6" onSubmit={handleSubmit}>
            <input 
              type="text" name="name" value={formData.name} onChange={handleChange} required
              placeholder="Full Name" 
              className="w-full bg-black/50 border border-white/20 rounded-xl px-5 py-4 text-white outline-none focus:border-brand-gold transition-colors" 
            />
            <input 
            ...
            <textarea 
              ...
              className="w-full bg-black/50 border border-white/20 rounded-xl px-5 py-4 text-white outline-none focus:border-brand-gold transition-colors resize-none"
            ></textarea>
            ...
            <button 
              ...
              className="w-full bg-brand-gold text-black py-4 rounded-xl text-sm font-black uppercase tracking-widest hover:bg-white transition-colors disabled:opacity-50"
            >
